...
export const Summary = () => {
  ...
  return (
    <div className="space-y-8 p-8 max-w-7xl mx-auto relative">
      ...
      {/* 1. Header Section */}
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pb-4 border-b border-[#262626]">
        <div>
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-4 py-2 border border-[#DC2626] hover:border-red-500 bg-red-950/10 hover:bg-[#DC2626]/20 text-[#DC2626] hover:text-white font-extrabold uppercase tracking-wider text-2xs rounded-xl shadow-lg transition-all flex items-center gap-2 active:scale-95"
          >
          ...
          <button
            ...
            disabled={refreshing}
            className="px-3 py-2 border border-[#262626] hover:border-white bg-[#171717] hover:bg-[#2B2B2B] text-white rounded-xl text-xs font-bold transition-all flex items-center gap-2 disabled:opacity-50"
          >
      ...
      >
        {[
          { name: "Total Tasks", val: totalTasks, icon: Activity, color: "text-[#A3A3A3] border-[#262626]" },
          ...
          { name: "Overdue", val: overdueCount, icon: AlertCircle, color: overdueCount > 0 ? "text-[#DC2626] border-[#DC2626]/40 shadow-[0_0_15px_rgba(220,38,38,0.05)]" : "text-[#737373] border-[#262626]" },
          { name: "Due Today", val: dueTodayCount, icon: Calendar, color: dueTodayCount > 0 ? "text-[#06B6D4] border-cyan-950/80 shadow-[0_0_15px_rgba(6,182,212,0.05)]" : "text-[#737373] border-[#262626]" },
          { name: "Due Week", val: dueThisWeekCount, icon: Calendar, color: "text-[#8B5CF6] border-violet-950/40" },
          { name: "High Priority", val: highPriorityCount, icon: Flame, color: highPriorityCount > 0 ? "text-[#F97316] border-orange-950/85" : "text-[#737373] border-[#262626]" }
        ].map((s) => {
          const Icon = s.icon;
          return (
            <motion.div
            ...
            >
              <div className="flex justify-between items-start">
                <span className="text-[10px] font-extrabold uppercase tracking-wider text-[#737373] leading-none">
                  {s.name}
                </span>
                <Icon className="w-4 h-4 opacity-75" />
              </div>
              <div className="text-xl font-bold tracking-tight mt-3 text-white">
                {s.val}
              </div>
            </motion.div>
          );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <motion.div
            ...
            className="border border-[#262626] bg-[#171717] rounded-2xl shadow-xl overflow-hidden relative"
          >
            <div className="absolute top-0 right-0 w-32 h-32 bg-red-950/10 rounded-full blur-3xl pointer-events-none" />
            <div className="bg-[#0D0D0D] px-5 py-4 border-b border-[#262626] flex items-center justify-between">
              <h3 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2">
                <Sparkles className="w-4.5 h-4.5 text-[#DC2626]" />
                <span>Coach Daily Briefing</span>
              </h3>
              <span className="text-[9px] font-extrabold text-[#22C55E] uppercase tracking-widest bg-emerald-950/30 border border-emerald-900/40 px-2 py-0.5 rounded-lg">
                AI Active
              </span>
            </div>
            
            <div className="p-6 space-y-6">
              <div className="text-xs leading-relaxed text-[#A3A3A3] bg-[#0F0F0F] border border-[#262626]/60 p-5 rounded-2xl relative overflow-hidden font-medium">
                <span className="absolute top-3 left-4 text-4xl text-[#262626] select-none font-serif leading-none">“</span>
                <p className="pl-6 relative z-10 leading-normal italic">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-4 bg-[#0F0F0F] border border-[#262626] rounded-xl flex items-center justify-between">
                  <div>
                    <span className="block text-[9px] font-extrabold text-[#737373] uppercase tracking-wider">
                  ...
                  <Clock className="w-8 h-8 text-[#DC2626] opacity-30" />
                </div>
                <div className="p-4 bg-[#0F0F0F] border border-[#262626] rounded-xl flex items-center justify-between">
                  <div>
                    <span className="block text-[9px] font-extrabold text-[#737373] uppercase tracking-wider">
                  ...
                  <Calendar className="w-8 h-8 text-[#DC2626] opacity-30" />
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div
            ...
            className="border border-[#262626] bg-[#171717] rounded-2xl shadow-xl overflow-hidden"
          >
            <div className="bg-[#0D0D0D] px-5 py-4 border-b border-[#262626]">
              <h3 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2">
            ...
            <div className="p-6">
              {recommendedTasks.length === 0 ? (
                <div className="text-center py-8">
                  <p className="text-xs text-[#737373] italic">No pending recommendations left. Add tasks to calculate priority.</p>
                </div>
              ) : (
                <div className="space-y-4">
                  {recommendedTasks.map((t, idx) => {
                    ...
                    const priorityClass = fullTask?.priority === 'High' 
                      ...
                      : 'text-[#A3A3A3] border-[#262626] bg-[#0F0F0F]';

                    return (
                      <div
                        key={t.id}
                        className={`flex items-start space-x-4 p-4 rounded-xl border border-[#262626] bg-[#0F0F0F]/60 hover:border-red-900/30 transition-all duration-200 group relative ${isCompleted ? 'opacity-50' : ''}`}
                      >
                        {/* Queue Indicator Badge */}
                        <div className="w-6 h-6 rounded-full bg-[#111111] border border-[#262626] text-white flex items-center justify-center text-[10px] font-extrabold flex-shrink-0 mt-0.5">
                          {idx + 1}
                        </div>
                        ...
                        <button
                          ...
                          className="w-5.5 h-5.5 rounded-full border border-[#262626] group-hover:border-[#DC2626] flex items-center justify-center text-transparent hover:text-emerald-500 hover:border-emerald-500 transition-all flex-shrink-0 mt-0.5"
                        >
                          {isCompleted ? (
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-2">
                            <h4 className={`text-xs font-semibold text-white group-hover:text-[#EF4444] transition-colors leading-tight ${isCompleted ? 'line-through text-[#737373]' : ''}`}>
                              {t.title}
                            </h4>
                            {fullTask && (
                            ...
                            {fullTask?.category && (
                              <span className="text-[9px] font-extrabold uppercase tracking-wider px-2 py-0.5 border border-[#262626] bg-[#111111] rounded-lg text-[#737373]">
                                {fullTask.category}
                              </span>
                            )}
                          </div>
                          ...
                          <div className="mt-2.5 bg-[#111111] border-l-2 border-[#DC2626] pl-3 py-1.5 rounded-r-lg">
                            <p className="text-[11px] leading-relaxed text-[#A3A3A3] italic">
                              <span className="font-bold text-white text-[9px] uppercase tracking-wider mr-1.5 not-italic">Coach Note:</span>
        ...
        <div className="space-y-8">
          ...
          <motion.div
            ...
            className="border border-[#262626] bg-[#171717] p-6 rounded-2xl shadow-xl flex flex-col items-center text-center relative"
          >
            <div className="w-full flex justify-between items-center pb-4 border-b border-[#262626] mb-6">
              <h3 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2">
            ...
            <div className="relative w-36 h-36 flex items-center justify-center mt-2">
              ...
              <div className="text-center">
                ...
                <span className="block text-[9px] font-extrabold text-[#737373] uppercase tracking-wider mt-1">
                  Score
                </span>
              </div>
            </div>
            ...
            {/* Score Class Badge */}
            <div className={`mt-5 px-3 py-1 border text-xs font-extrabold uppercase tracking-widest rounded-xl ${scoreBorder} ${scoreColor}`}>
              {scoreBadge}
            </div>

            <p className="text-[10px] text-[#737373] leading-normal uppercase tracking-wider mt-5 border-t border-[#262626]/40 pt-4 w-full text-center">
          ...
          <motion.div
            ...
            className="border border-[#262626] bg-[#171717] p-6 rounded-2xl shadow-xl"
          >
            <h3 className="text-xs font-bold text-white uppercase tracking-wider pb-4 border-b border-[#262626] mb-5 flex items-center gap-2">
            ...
            <div className="space-y-3.5">
              {(insights?.smart_suggestions || []).map((s, idx) => (
                <div key={idx} className="flex items-start space-x-3 bg-[#0F0F0F] border border-[#262626]/60 p-3.5 rounded-xl">
                  <Sparkles className="w-4 h-4 text-[#DC2626] flex-shrink-0 mt-0.5 animate-pulse" />
                  <p className="text-xs text-[#A3A3A3] leading-normal font-medium">
                    {s}
                  </p>
                </div>
              ))}
              {(!insights?.smart_suggestions || insights.smart_suggestions.length === 0) && (
                <p className="text-xs text-[#737373] italic">No suggestions compiled yet.</p>
              )}
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="space-y-4">
              {/* Productive Cat */}
              <div className="flex justify-between items-center p-3.5 bg-[#0F0F0F] border border-[#262626] rounded-xl">
                <div>
                  <span className="block text-[9px] font-extrabold text-[#737373] uppercase tracking-wider">
                ...
                <div className="w-8 h-8 rounded-lg bg-emerald-950/20 border border-emerald-900/30 flex items-center justify-center text-emerald-500 font-bold">
                  P
                </div>
              </div>
              ...
              <div className="flex justify-between items-center p-3.5 bg-[#0F0F0F] border border-[#262626] rounded-xl">
                ...
                <div className="w-8 h-8 rounded-lg bg-red-950/20 border border-red-900/30 flex items-center justify-center text-[#DC2626] font-bold">
                  D
                </div>
              </div>
              ...
              <div className="flex justify-between items-center p-3.5 bg-[#0F0F0F] border border-[#262626] rounded-xl">
                <div>
                  ...
                  <span className="text-xs font-bold text-white mt-1 block uppercase tracking-wide">
      ...
      {/* 4. Bottom Grid for breakdown & activity logs */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 border-t border-[#262626] pt-8">
        ...
        <motion.div
          ...
          className="border border-[#262626] bg-[#171717] p-6 rounded-2xl shadow-xl space-y-4"
        >
          <h3 className="text-xs font-bold text-white uppercase tracking-wider flex items-center gap-2">
              ...
              {Object.entries(categoryStats).map(([cat, counts]) => {
                ...
                return (
                  <div key={cat} className="space-y-1.5">
                    <div className="flex justify-between text-xs font-semibold text-[#A3A3A3]">
                      <span>{cat}</span>
                      <span className="text-white font-bold">
                        {counts.completed} / {counts.total} ({pct}%)
                      </span>
                    </div>
                    <div className="w-full bg-[#0F0F0F] h-2 rounded-full overflow-hidden p-0.5 border border-[#262626]">
                      <div
                    ...
                    <li key={act.id}>
                      <div className="relative pb-8">
                        {actIdx !== recentActivities.length - 1 ? (
                          <span
                            className="absolute top-4 left-4 -ml-px h-full w-0.5 bg-[#262626]"
                            aria-hidden="true"
                          />
                        ) : null}
                        ...
                        <div className="relative flex space-x-3.5">
                          ...
                          <div className="flex-1 min-w-0 pt-1.5 flex justify-between space-x-4">
                            ...
                            <div className="text-right text-[10px] font-bold text-[#737373] whitespace-nowrap uppercase">
      ...
      <AnimatePresence>
        {isFocusMode && (
          ...
          >
            {/* Overlay Header */}
            <div className="flex justify-between items-center max-w-5xl w-full mx-auto pb-6 border-b border-[#262626] mb-8">
              ...
              <button
                ...
                className="p-2 border border-[#262626] hover:border-white rounded-full bg-[#171717] hover:bg-[#2B2B2B] transition-all text-white flex items-center gap-1.5 text-xs font-bold uppercase tracking-wider px-4 py-2"
              >
                <X className="w-4 h-4" />
            ...
            <div className="flex-1 max-w-5xl w-full mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              ...
              <div className="flex flex-col items-center justify-center space-y-6">
                <div className="relative w-72 h-72 flex items-center justify-center">
                  ...
                  <div className="text-center z-10">
                    ...
                    <div className="text-[10px] font-extrabold uppercase tracking-widest text-[#737373] mt-2">
                      Timer Remaining
                    </div>
                  </div>
                </div>
                    ...
                    <button
                      ...
                      className={`px-3.5 py-1.5 border text-xs font-bold rounded-xl transition-all ${
                        timerTotal === m * 60
                          ...
                          : 'border-[#262626] hover:border-[#737373] text-[#A3A3A3]'
                      }`}
                    >
                      {m}m
                    </button>
                ...
                <div className="flex items-center space-x-4">
                  <button
                    ...
                    className="px-6 py-3 bg-[#DC2626] hover:bg-[#EF4444] text-white font-extrabold uppercase tracking-wider text-xs rounded-xl shadow-lg shadow-red-950/40 transition-all flex items-center gap-2 active:scale-95"
                  >
                  ...
                  <button
                    ...
                    className="p-3 border border-[#262626] hover:border-white bg-[#171717] hover:bg-[#2B2B2B] text-white rounded-xl transition-all"
                    title="Reset Timer"
                  >
              ...
              <div className="space-y-6">
                <div className="border border-[#262626] bg-[#171717] p-6 rounded-2xl shadow-xl relative overflow-hidden">
                  ...
                  <p className="text-[10px] font-bold text-[#737373] uppercase tracking-widest mb-6">
                    Top 3 items. Focus completely on completing them in order.
                  </p>

                  {topFocusTasks.length === 0 ? (
                    <div className="text-center py-8">
                      <p className="text-xs text-[#737373] italic">No pending focus objectives left. Great job!</p>
                    </div>
                  ) : (
                    <div className="space-y-4">
                      {topFocusTasks.map((t) => (
                        <div
                          key={t.id}
                          className="flex items-start space-x-3.5 p-4 rounded-xl border border-[#262626]/60 bg-[#0F0F0F] hover:border-red-900/40 transition-all group"
                        >
                          <button
                            onClick={() => handleToggleTaskComplete(t.id, t.title)}
                            className="w-5.5 h-5.5 rounded-full border border-[#262626] group-hover:border-[#DC2626] flex items-center justify-center text-transparent hover:text-emerald-500 hover:border-emerald-500 transition-all flex-shrink-0 mt-0.5"
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <p className="text-[11px] text-[#737373] leading-snug mt-1.5 italic">
                              {t.reason}
                            </p>
                          </div>
                        </div>
                  ...
                  <div className="mt-6 pt-4 border-t border-[#262626] flex justify-between items-center text-[10px] font-extrabold text-[#737373] uppercase tracking-wider">
